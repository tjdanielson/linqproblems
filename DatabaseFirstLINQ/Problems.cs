...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemOne()
        {
            ...
            //HINT: .ToList().Count -- FindAll(u => u.id > 0);
        ...
        private void ProblemFive()
        {
            ...
            DateTime date = new DateTime(2016, 1, 1, 0, 0, 0);

            var before2016 = users.Where(u => u.RegistrationDate < date);
        ...
        private void ProblemSix()
        {
            ...
            DateTime date2 = new DateTime(2018, 1, 1, 0, 0, 0);

            var userRange = users.Where(u => u.RegistrationDate >= date1 && u.RegistrationDate <= date2);

            foreach (User user in userRange)
            {
                Console.WriteLine($"Email: {user.Email} Registration Date: {user.RegistrationDate}");
            }
        ...
        private void ProblemFourteen()
        {
            ...
            var productId = _context.Products.Where(r => r.Name == "Computer").Select(r => r.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
        ...
        private void ProblemSixteen()
        {
            ...
            var product = _context.Products.Where(u => u.Name == "Computer").SingleOrDefault();
